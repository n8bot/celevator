...
local pieces = {
	...
	},
	{
		...
		tiles = {
			...
			"celevator_car_side_center_overlay.png^celevator_car_glass.png^celevator_car_wall_bottom.png^celevator_car_wall_vent.png",
			"celevator_car_wall_bottom.png^celevator_car_wall_vent.png^celevator_car_glass.png^celevator_car_side_center_overlay.png",
	...
	},
	{
		...
		tiles = {
			"celevator_car_metal_floor.png",
			"celevator_car_bottom.png",
			"celevator_car_side_overlay.png^[transformFX^celevator_car_glass.png^celevator_car_wall_bottom.png",
			"celevator_car_wall_bottom.png^celevator_car_glass.png^celevator_car_side_overlay.png",
			"celevator_car_wall_bottom.png^celevator_car_glass.png",
	...
	},
	{
		...
		tiles = {
			"celevator_car_metal_floor.png",
			"celevator_car_bottom.png",
			"celevator_car_wall_bottom.png^[transformR270^celevator_car_glass.png^celevator_car_side_overlay.png^[transformR90",
			"celevator_car_side_overlay.png^celevator_car_glass.png^celevator_car_wall_bottom.png",
			"celevator_car_wall_bottom.png^celevator_car_glass.png",
			"celevator_car_glass.png^celevator_car_wall_bottom.png",
		},
	},
	...
	},
	{
		...
		tiles = {
			"celevator_car_glass.png",
			"celevator_car_glass.png",
			"celevator_car_side_center2_overlay.png^celevator_car_glass.png^celevator_car_handrail_end.png",
			"celevator_car_handrail_end.png^[transformFX^celevator_car_glass.png^celevator_car_side_center2_overlay.png",
			"celevator_car_glass.png",
		},
	},
	{
		...
		tiles = {
			"celevator_car_glass.png",
			"celevator_car_glass.png",
			"celevator_car_glass.png^(celevator_car_handrail_end.png^[transformFX)",
			"celevator_car_handrail_end.png^celevator_car_glass.png",
			"celevator_car_glass.png",
			"celevator_car_glass.png",
		},
	},
	...
	},
	{
		...
		tiles = {
			"celevator_car_glass.png",
			"celevator_car_glass.png",
			"celevator_car_handrail_center.png^celevator_car_glass.png^celevator_car_side_center2_overlay.png",
			"celevator_car_side_center2_overlay.png^celevator_car_glass.png^celevator_car_handrail_center.png",
			"celevator_car_glass.png",
		},
	},
	{
		...
		tiles = {
			"celevator_car_glass.png",
			"celevator_car_glass.png",
			"celevator_car_handrail_end.png^[transformFX^celevator_car_glass.png",
			"celevator_car_glass.png^celevator_car_handrail_end.png",
			"celevator_car_glass.png",
			"celevator_car_glass.png",
		},
	},
	...
	},
	{
		...
		tiles = {
			...
			"celevator_car_metal_ceiling.png",
			"celevator_car_side_center_overlay.png^celevator_car_glass.png",
			"celevator_car_glass.png^celevator_car_side_center_overlay.png",
			"celevator_car_glass.png",
		},
		_cartopbox = true,
	},
...
celevator.car.register("fullglass",pieces,vector.new(2,3,3))


core.register_node("celevator:car_fullglass",{
	description = S("Full-Glass Elevator Car"),
	paramtype2 = "4dir",
	buildable_to = true,
	inventory_image = "celevator_car_fullglass_inventory.png",
	wield_image = "celevator_car_fullglass_wield.png",
	...
	after_place_node = function(pos,player)
		...
		for x=0,1,1 do
			for y=0,2,1 do
				for z=0,2,1 do
					local piecename = string.format("celevator:car_fullglass_%d%d%d",x,y,z)
					local placeoffset = vector.new(x,y,z)
					local placepos = vector.add(pos,vector.rotate_around_axis(placeoffset,vector.new(0,1,0),facedir))
...
celevator.car.types.fullglass.remove = function(rootpos,rootdir)
	local toberemoved = {
